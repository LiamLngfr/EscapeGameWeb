...
INSERT INTO items VALUES (1, 'Pingouin', null, 4731, null, null, false, false, 7, 'assets/Image/pingouin.png', 64, ST_SetSRID(ST_MakePoint(47.537842,-18.947856 ), 4326), null, 'Bien joué, d’après mes infos, le prochain lieu où tu dois aller est la résidence de la Dame de 
...
INSERT INTO items VALUES (3, 'Pingouin_bis', null, null, null, null, false, false, 5, 'assets/Image/pingouin_bis.png', 64, ST_SetSRID(ST_MakePoint(-40.913086, 80.802046), 4326), 'Arrivé sur place tu croise des scientifique et les questionne sur l''indice que tu as. Alors le scientifique te répond: "Ce n''est pas le type de pingouin que tu cherche, essaye plutôt d''aller faire un tour vers Madagascar..."')
